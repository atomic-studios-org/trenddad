...
const generateKeywords = async () => {
  ...
  const keywords =
    "buy stash products, order stash products, hide items in products, hide money in products, juwels in products, hide valueable items, hide festival items, festival stash products";
  return keywords;
};
