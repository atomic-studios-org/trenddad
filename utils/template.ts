export const generateTemplate = (BASE_URI: string, code: string, email: string) => {
    return ` <!doctype html>
    ...
    <body style="background-color:#f3f3f5;">
      <div style="display:none;font-size:1px;color:#ffffff;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;">Your code is [${code}] </div>
