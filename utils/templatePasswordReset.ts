    ...
    return ` <!doctype html>
      ...
      <body style="background-color:#f3f3f5;">
        ...
        <div style="display:none;font-size:1px;color:#ffffff;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;"> 
          ...
          <span>Reset your password</span> </div>
                        ...
                        <tr>
                          <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                            <div style="font-family:Poppins, Helvetica, Arial, sans-serif;font-size:20px;font-weight:300;line-height:30px;text-align:left;color:#003366;">
                              <img style="width: 100px; height: auto;" src="https://trenddad.com/trend-dad.png" alt="trend dad" />
                              <h1 style="margin: 0; font-size: 32px; line-height: 50px; font-weight: 400;"> Reset your password</h1>
                            </div>
                          </td>
                        </tr>
                        <tr>
                          <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                            <div style="font-family:Poppins, Helvetica, Arial, sans-serif;font-size:20px;font-weight:300;line-height:30px;text-align:left;color:#030304;">Please click the button below to <a href="${BASE_URI}/reset-password?email=${email}&code=${uuid}" style="color: #000000;">Reset your password</a>. Once you have completed the process, you can start using our service.</div>
                          </td>
                        </tr>
                        <tr>
