    ...
    <div class="w-11/12 md:flex md:mb-10 mb-40 grid md:mt-0 mt-20 grid-cols-1 gap-20 md:gap-0">
      ...
      <div class="6/12">
        <div class="md:px-16 px-2 flex flex-col">
          ...
          >
         <div class="flex  gap-1"> <span>Collection: </span><span>{{ data?.data.collection }}</span></div>
          ...
          <div class="flex gap-2 items-end"><div class="text-2xl  px-4 py-3  bg-gray-900 text-white font-bold mt-2 "><span>€ {{ data?.data.price?.toFixed(2) }},-</span></div>
          <div>
            <button
