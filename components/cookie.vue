...
<template>
   <div v-if="openPopup" class="fixed  md:bottom-4 bottom-8 left-0 z-[60] sm:max-w-sm md:p-4 p-1 mx-auto ">
          <div class="p-4 bg-gradient-to-br from-black to-violet rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700">
