...
<template>
  ...
  <div
    class="absolute z-20 gap-1 flex top-0 h-6 w-screen items-center justify-center bg-slate-900 text-xs text-white"
  >
  ...
  <NuxtLink
    href="/home"
    class="absolute flex gap-1 items-center top-10 md:top-8 md:left-8 lg:left-16 lef-2 decoration-none ml-4"
    ><nuxt-img
      :height="200"
      :width="700"
      class="md:h-6 h-4 w-auto"
      src="/trend.png"
      alt="" />
    <nuxt-img
      :height="200"
      :width="600"
      class="md:h-6 h-4 w-auto animate-flip"
      src="/snor.png"
      alt="" />
    <nuxt-img
      :height="200"
