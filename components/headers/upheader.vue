...
<template>
  <div className="absolute z-20 flex top-0 h-6 w-screen items-center justify-center bg-purple-400 text-xs text-white">
        <span>Get 10% off with code ' DADDY10 '</span>
      </div>
